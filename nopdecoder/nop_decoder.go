...
func (d NopDecoder) EndStream(key []byte, items int, eid string, info []rdb.StreamCgroupData) {}
func (d NopDecoder)    StreamListPack(key []byte, entry_id string, data string)               {}
